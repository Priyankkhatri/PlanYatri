  ...
  mountain: {
    ...
    matches: [
      ...
      },
      {
        ...
        img: 'https://images.pexels.com/photos/417173/pexels-photo-417173.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
      },
      {
        id: 'swiss-alps',
    ...
    matches: [
      {
        ...
        img: 'https://images.pexels.com/photos/1450353/pexels-photo-1450353.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
      },
      {
        id: 'gokarna-boho',
      ...
      },
      {
        ...
        img: 'https://images.pexels.com/photos/15286/pexels-photo.jpg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
      },
    ],
  },
  heritage: {
...
export default function TravelStyle() {
  ...
  const handlePlanInTrips = (dest: any) => {
    router.push('/trips')
  }
