...
const EXPERIENCES = [
  ...
  { name: 'Ayurvedic Spa & Houseboat Retreat', location: 'Kerala, India', cat: 'Wellness', duration: '1 Day', price: '₹4,500', rating: 4.8, reviews: 320, img: WIKIMEDIA_REAL_IMAGES['kerala'], tag: 'Popular' },
  { name: 'Scuba Diving & Coral Safari', location: 'Havelock, Andaman', cat: 'Adventure', duration: '5h', price: '₹8,500', rating: 4.9, reviews: 560, img: WIKIMEDIA_REAL_IMAGES['andaman'], tag: 'Bucket List' },
  { name: 'Pasta Making Masterclass', location: 'Rome, Italy', cat: 'Culture', duration: '2.5h', price: '₹6,800', rating: 4.7, reviews: 210, img: WIKIMEDIA_REAL_IMAGES['amalfi'], tag: 'Trending' },
  { name: 'Northern Lights Glass Igloo Safari', location: 'Lapland, Finland', cat: 'Nature', duration: '4h', price: '₹18,500', rating: 4.8, reviews: 430, img: WIKIMEDIA_REAL_IMAGES['switzerland'], tag: 'Exclusive' },
  { name: 'Traditional Uji Tea Ceremony', location: 'Kyoto, Japan', cat: 'Culture', duration: '3h', price: '₹7,200', rating: 4.9, reviews: 370, img: WIKIMEDIA_REAL_IMAGES['kyoto'], tag: 'Trending' },
]
