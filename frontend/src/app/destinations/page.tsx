...
const INITIAL_DESTINATIONS = [
  // 🇮🇳 INDIA DESTINATIONS (Curated & Authentic Real Photos)
  {
  ...
  },
  {
    ...
    img: WIKIMEDIA_REAL_IMAGES['spiti'],
  ...
  },
  {
    ...
    img: WIKIMEDIA_REAL_IMAGES['meghalaya'],
  ...
  },
  {
    ...
    img: WIKIMEDIA_REAL_IMAGES['andaman'],
  ...
  },
  {
    ...
    img: WIKIMEDIA_REAL_IMAGES['rishikesh'],
  ...
  },
  {
    ...
    img: WIKIMEDIA_REAL_IMAGES['kashmir'],
    activities: ['Hiking & Trekking', 'Water Sports'],
    duration: '7 Days / 6 Nights',
    safetyScore: '9.5 / 10',
  ...
  },
  {
    ...
    img: WIKIMEDIA_REAL_IMAGES['hampi'],
  ...
  },
  {
    ...
    img: WIKIMEDIA_REAL_IMAGES['jaisalmer'],
    activities: ['Museums & Art', 'Hiking & Trekking'],
    duration: '5 Days / 4 Nights',
    safetyScore: '9.6 / 10',
    bestSeason: 'October to March',
  ...
  },
  {
    ...
    img: WIKIMEDIA_REAL_IMAGES['varanasi'],
    activities: ['Museums & Art'],
    duration: '4 Days / 3 Nights',
    safetyScore: '9.6 / 10',
    bestSeason: 'October to March',
  ...
  },
  {
    ...
    img: WIKIMEDIA_REAL_IMAGES['gokarna'],
    activities: ['Hiking & Trekking', 'Water Sports'],
    duration: '4 Days / 3 Nights',
  ...
  },
  {
    ...
    img: WIKIMEDIA_REAL_IMAGES['serengeti'],
    activities: ['Hiking & Trekking'],
    duration: '8 Days / 7 Nights',
    safetyScore: '9.6 / 10',
  ...
  },
  {
    ...
    img: WIKIMEDIA_REAL_IMAGES['patagonia'],
    activities: ['Hiking & Trekking'],
...
export default function Destinations() {
  ...
  const handleGenerateAI = async (e) => {
    ...
    try {
        ...
        generatedDests = await Promise.all(
          res.data.destinations.map(async (d) => {
            ...
            return {
              ...d,
              img: realImg,
              priceINR: d.priceInINR || perPerson,
              priceUSD: d.priceInUSD || Math.round(perPerson / 85),
              priceDisplayINR: d.priceDisplayINR || `₹${(d.priceInINR || perPerson).toLocaleString('en-IN')}`,
              priceDisplayUSD: d.priceDisplayUSD || `$${(d.priceInUSD || Math.round(perPerson / 85)).toLocaleString('en-US')}`,
              isIndia: true,
              isAiGenerated: true,
      ...
      console.warn('[PlanYatri AI] Live backend fetch fallback:', err)
    }

    // Fallback if backend returned empty array or errored out
    if (generatedDests.length === 0) {
      const realImgUrl = await getRealPlaceImage(currentPrompt, 'https://images.unsplash.com/photo-1615836245337-f5b9b2303f10?w=900&h=1100&q=85&auto=format&fit=crop')
      const primaryDemo = {
        id: `demo-ai-${Date.now()}-001`,
        name: `${currentPrompt.split(' ')[0]} — Custom AI Expedition`,
        country: 'India',
        region: currentPrompt.split(' ')[0],
        tag: 'HERITAGE',
        rating: 4.9,
        reviews: '3.2k',
        description: `A bespoke luxury escape crafted for "${currentPrompt}". Explore iconic landmarks, authentic local culinary secrets, and private guided immersions customized to your travel pace.`,
        activities: ['Heritage Walks', 'Guided Sightseeing', 'Cultural Shows', 'Local Food Trails'],
        duration: `${parsedDays} Days / ${parsedDays - 1} Nights`,
        safetyScore: '9.9 / 10 (Solo & Group Safe)',
        bestSeason: 'Year Round',
        highlights: [
          'Private Landmark Guided Tour',
          'Sunset Viewpoint Exploration',
          'Authentic Heritage Dining Experience',
          'Boutique Local Market Walk',
        ],
        imageQuery: currentPrompt,
        img: realImgUrl,
        priceINR: perPerson,
      ...
      generatedDests = [primaryDemo]
    }

    const spotlightItem = generatedDests[0]
              ...
              {aiSpotlight && (
                <motion.section className="ai-spotlight-card" variants={spotlightEnter} initial="initial" animate="animate" exit="exit">
                  ...
                  <div className="asc-content">
                    ...
                    {/* Google Maps Animated Route Simulator */}
                    <GoogleAnimatedMap
                      locationName={aiSpotlight.name}
                      destName={aiSpotlight.name}
                      daysPlan={aiSpotlight.daysPlan || []}
                    />
        ...
        >
          ...
          >
            ...
            <div className="dest-modal-body">
              ...
              {/* Google Maps Animated Route Simulator & Satellite View */}
              <GoogleAnimatedMap
                locationName={selectedModalDest.name}
                destName={selectedModalDest.name}
                daysPlan={selectedModalDest.daysPlan || []}
              />
