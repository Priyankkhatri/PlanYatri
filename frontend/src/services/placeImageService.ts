...
export const WIKIMEDIA_REAL_IMAGES: Record<string, string> = {
...
const IMAGE_CACHE: Record<string, string> = { ...WIKIMEDIA_REAL_IMAGES };
...
export async function getRealPlaceImage(query: string, defaultFallback = '') {
...
export const fetchPlaceImage = getRealPlaceImage;
