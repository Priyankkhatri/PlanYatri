...
function AppContent() {
  ...
  return (
    <>
      <Helmet>
        <title>PlanYatri — Premium Travel Planner</title>
        <meta name="description" content="Plan your dream journeys, discover hidden gems, and create unforgettable memories with PlanYatri." />
        <meta name="keywords" content="travel, trip planner, destinations, adventure, solo travel, PlanYatri" />
        <meta property="og:title" content="PlanYatri — Travel Planning Made Simple" />
